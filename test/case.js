...
const { config } = require('jud-js-runtime')
  ...
  it('could check real DOM structure in render', () => {
    ...
    const code = [
      ...
      var image = document.createElement('image', {
        attr: { src: 'http://alibaba.github.io/jud/img/jud_logo_blue@3x.png' },
    ...
    expect(instance.getRealRoot()).eql({
      ...
      event: ['click'],
      children: [
        { type: 'image', attr: { src: 'https://raw.githubusercontent.com/vkiding/jud-toolkit/master/jud.png' }, style: { width: 360, height: 82 }},
